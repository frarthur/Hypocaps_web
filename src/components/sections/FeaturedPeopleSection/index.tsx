...
function FeaturedPeopleTwoCol({
  ...
  return (
    <div
      className={classNames("grid", "gap-6", "grid-cols-2", "max-w-3xl", "mx-auto", {
        "mt-8": hasTopMargin,
      })}
              ...
              a: {
                component: ({ children, href, title }: any) => {
                  ...
                  if (href?.includes("wikipedia") && title) {
                    return (
                      <WikiTooltip title="Diabète de type 1" description={title} url={href}>
                        {children}
                      </WikiTooltip>
                    );
                  }
